...
export default function AssetForm({ data, setData, errors, processing, submit, isEditing = false }: AssetFormProps) {
    return (
            ...
            <Card className="rounded border shadow-none">
                <div className="flex items-center justify-between pr-6 border-b border-border/50">
                    <CardHeader>
                        ...
                        <CardDescription>
                            {isEditing ? 'Update the information for this asset.' : 'Basic information about your asset.'}
                        </CardDescription>
                    </CardHeader>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Button
                            type="submit"
                            disabled={processing}
                            className={`rounded ${isEditing ? 'px-6' : ''} bg-[#f0642d] hover:bg-[#d95627] text-white border-none`}
                        >
