...
export default function DeleteUser() {
    return (
        <div className="space-y-6 p-4 rounded border">
            <Heading
                variant="small"
                title="Delete account"
                description="Delete your account and all of its resources"
            />
            <div className="space-y-4 rounded border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
