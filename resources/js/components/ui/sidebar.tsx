...
function SidebarTrigger({
    ...
    return (
        ...
        >
            <PanelLeft />
            {/* {isMobile || state === "collapsed" ? <PanelLeft /> : <PanelLeftCloseIcon />} */}
    ...
    return (
        <main
            ...
            className={cn(
                ...
                // Removed m-2, rounded-xl, shadow-sm, and height offsets
                "peer-data-[variant=inset]:min-h-svh md:peer-data-[variant=inset]:ml-0",
                className
            )}
            {...props}
        />
