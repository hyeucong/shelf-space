...
export default function AddAssets({ kit, assets: availableAssets, categories, columnPreferences, existingAssetIds, locations, savedFilters, filters, sorts }: AddAssetsPageProps) {
    ...
    const handleConfirm = () => {
        ...
        router.post(addAssets(kit.id).url, {
    ...
    const handleCancel = () => {
        router.visit(assets(kit.id).url);
    };
