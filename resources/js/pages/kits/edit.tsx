...
export default function Edit({ kit }: { kit: Kit }) {
    ...
    const { data, setData, patch, processing, errors } = useForm({
        ...
        category_id: kit.category_id ? String(kit.category_id) : '',
        location_id: kit.location_id ? String(kit.location_id) : '',
    });
                    ...
                    <CardContent className="space-y-6">
                        <div className="flex justify-between border-b border-border/50 pb-6">
                            <CardHeader>
                                ...
                                <CardDescription>Update information about your kit.</CardDescription>
                            </CardHeader>
